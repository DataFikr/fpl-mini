...
const FAQS: { q: string; a: React.ReactNode; aText: string }[] = [
  ...
  { q: 'What can I do with FPL Ranker?', a: 'Enter your team ID to see your live squad and gameweek points, a Rank My Team verdict, your mini-league standings with ESPN-style headlines and rank analytics, plus a blog with FPL tips, transfer analysis and gameweek team reveals.', aText: 'Enter your team ID to see your live squad and gameweek points, a Rank My Team verdict, your mini-league standings with ESPN-style headlines and rank analytics, plus a blog with FPL tips, transfer analysis and gameweek team reveals.' },
