...
export default function BeyondThePointsBlog() {
  return (
    <>
      <Header />
      <div className="min-h-screen bg-gradient-to-br from-fpl-dark via-fpl-primary/5 to-fpl-dark pt-20">
        ...
        <nav aria-label="Breadcrumb" className="container mx-auto px-4 pt-6">
          <ol className="flex items-center gap-2 text-sm font-inter text-fpl-text-secondary">
            ...
            <li aria-hidden="true">/</li>
            <li className="text-fpl-accent" aria-current="page">Beyond the Points</li>
          </ol>
        </nav>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center mb-12">
              <div className="text-sm text-fpl-text-secondary font-inter mb-4">January 5, 2026</div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="backdrop-blur-fpl bg-fpl-dark/40 rounded-fpl p-8 border border-fpl-primary/20 mb-8">
              ...
              <p className="text-lg text-fpl-text-secondary font-inter leading-relaxed mt-4">
                At <span className="text-fpl-accent font-semibold">fplranker.com</span>, we believe every mini-league deserves the &ldquo;Sky Sports&rdquo; treatment. We&apos;ve built a suite of features designed to turn your casual Saturday afternoon into a week-long drama filled with banter, headlines, and deep-dive analytics.
              </p>
