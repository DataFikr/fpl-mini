        ...
        <div className="p-2 sm:p-4 overflow-y-auto flex-1">
          {isLoading ? (
            ...
            <div className="space-y-3">
              ...
              <div className="relative bg-gradient-to-b from-green-400 to-green-600 rounded-lg mx-1 sm:mx-2 p-3 sm:p-4 h-[450px] sm:h-[650px] lg:h-[700px]">
                {/* Pitch Markings */}
                ...
                <div className="relative z-10 w-full h-full">
                  ...
                  {/* Defenders - positioned at 30% from top with increased horizontal spacing */}
                  <div
                    className="absolute w-full flex justify-center"
                    style={{ top: '30%', transform: 'translateY(-50%)' }}
                  >
                    <div className="flex gap-6 sm:gap-12 md:gap-14 justify-center" style={{ maxWidth: '98%' }}>
                  ...
                  {/* Midfielders - positioned at 55% from top with increased spacing */}
                  <div
                    className="absolute w-full flex justify-center"
                    style={{ top: '55%', transform: 'translateY(-50%)' }}
                  >
                    <div className="flex gap-6 sm:gap-12 md:gap-14 justify-center" style={{ maxWidth: '98%', flexWrap: 'nowrap' }}>
                  ...
                  {/* Forwards - positioned at 80% from top with increased spacing */}
                  <div
                    className="absolute w-full flex justify-center"
                    style={{ top: '80%', transform: 'translateY(-50%)' }}
                  >
                    <div className="flex gap-10 sm:gap-16 md:gap-20 justify-center">
